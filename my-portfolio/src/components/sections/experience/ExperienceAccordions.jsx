            ...
            {experiences.map((exp, index) => {
                ...
                return (
                    <AccordionItem key={index} value={`item-${index}`} className="border-none">
                        <Card className="w-full overflow-hidden border-border/20 bg-card/50 backdrop-blur-sm transition-all hover:bg-card/60">
                            <AccordionTrigger className="w-full px-4 py-0 text-left hover:no-underline group focus-visible:ring-0 [&>svg]:hidden">
                                <div className="flex flex-col md:flex-row gap-6 w-full">
                                    {/* Image Container */}
                                    <div className="w-full md:w-72 h-50 md:h-42 bg-muted/20 rounded-lg relative flex-shrink-0 border border-border/20 overflow-hidden transition-all duration-300 ease-out hover:scale-106 hover:z-50 hover:shadow-xl hover:border-primary/50 group/video">
